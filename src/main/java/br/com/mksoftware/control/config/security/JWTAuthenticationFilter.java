...
import br.com.mksoftware.control.dtos.resquest.CredenciaisRequest;
...
private AuthenticationManager authenticationManager;
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
		...
		try {
			CredenciaisRequest creds = new ObjectMapper()
	                .readValue(req.getInputStream(), CredenciaisRequest.class);
